...
axis([0,length(a),0,0.5])

%plot images with segment shown
h1 = subtightplot(2,3,4), imshow(gt)
line(x,y)
title('Ground truth','fontweight','normal')
h2 = subtightplot(2,3,5), imshow(blurred)
line(x,y)
h3 = title('Blurred','fontweight','normal')
subtightplot(2,3,6), imshow(deblurred)
line(x,y)
title('Deblurred','fontweight','normal')
